                ...
                <div className='flex pt-4'>
                    <div className="w-full ">
                            ...
                            <div className="w-full">
                                <div className="flex">
                                    <div className="form-control w-full">
                                        ...
                                        <input type="date" className="input input-bordered text-sm rounded-2xl border-disabled w-full"/>
                                    </div>
                        ...
                        <div className=" w-full mt-4">
                            ...
                            <button className='flex justify-center items-center font-semibold text-white text-base w-full h-[50px] py-2 bg-primary rounded-xl hover:opacity-80'>
