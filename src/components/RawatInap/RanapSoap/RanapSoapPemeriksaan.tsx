...
import RiwayatSoapRanap from './ComponentsSoapPemeriksaan/RiwayatSoap'
import { ArrowsRightLeftIcon } from '@heroicons/react/24/solid'
import InsertSoapRanap from './ComponentsSoapPemeriksaan/InsertSoap'
    ...
    <div className='flex-auto min-w-fit overflow-x-auto'>
      ...
      <div className={`flex flex-row w-max ${isReverse ? 'flex-row-reverse' : 'flex-row'} mt-4`}>
        <div className='w-[850px]'>
          ...
          <div>
            <RiwayatSoapRanap onRiwayatObatChange={handleRiwayatObatChange} />
          </div>
        </div>
        <div className={`${isReverse ? 'max-w-4xl' : 'max-w-4xl'} ${isReverse ? 'mr-3' : 'ml-3'}`}>
          ...
          <div className='rounded-xl mt-4 p-4 bg-slate-100 w-full '>
            ...
            <InsertSoapRanap copyResep={riwayatObat} />
          </div>
        </div>
      </div>
    </div>
