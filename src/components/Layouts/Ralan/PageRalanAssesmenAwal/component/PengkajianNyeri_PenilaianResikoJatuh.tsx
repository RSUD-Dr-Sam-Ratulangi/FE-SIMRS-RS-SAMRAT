    ...
    <>
      ...
      <div className='border rounded-2xl p-2 grid mt-3 gap-3 w-full'>
        <div className='flex w-full'>
          <div>
            <label className='label font-bold text-lg'>V. PENILAIAN RESIKO JATUH</label>
                ...
                <div className='p-2'>
                  <div className='grid gap-2'>
                    <div className='flex gap-5'>
                      ...
                      <div>
                        <label className='label font-bold text-sm'>Jam Dilaporkan</label>
                        <input
                          value={ketLapor}
      ...
      <div className='border mt-3 p-2 rounded-2xl'>
        <label className='label font-bold'>VII. PENILAIAN TINGKAT NYERI</label>
